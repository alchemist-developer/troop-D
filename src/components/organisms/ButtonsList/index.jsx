    ...
    return (
        <Box direction="column" justify="center" align="center">
            ...
            <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "15px" }}>
                <li ><Button href="/" padding="20px 20px" width="200%" height="50px" text={[<Image src={InicioFrame} key="1" alt="frame" />, "⠀Início"]} color={theme.colors.senaryColor} bg={theme.colors.quinaryColor} /></li>
